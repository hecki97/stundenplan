...
<?php include("$root/stundenplan/res/php/_eintragen.php"); ?>
	...
	<body class="metro" style="text-align: center;">
        ...
        <form action="eintragen.php" method="post">
          ...
          <?php if ($_SERVER['REQUEST_METHOD'] == 'POST')
          {
              ...
              file_put_contents("$root/stundenplan/res/data/".$_SESSION['username'].".data", json_encode($array));

              $arArray = json_decode(file_get_contents("$root/stundenplan/res/data/".$_SESSION['username'].".data"), true);
          ?>
          <table align="center" border="1">
            <tr>
              <td>/</td>
