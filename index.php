...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="metro">
		<header>
          <nav class="navigation-bar dark fixed-top">
            <nav class="navigation-bar-content">
                <a href="#" class="element"><span class="icon-home"></span> Stundenplan-online<sup><?=$lang; ?></sup></a>
		...
		<table text-align="center">
			...
			<tr>
				<form action="./login.php"><input type="submit" value="<?=$string['login']['button.submit.anmelden']; ?>" /></form>
				<br/><form action="./registration.php"><input type="submit" value="<?=$string['login']['button.submit.registrieren']; ?>" /></form>
			</tr>
		</table>
	</body>
</html>