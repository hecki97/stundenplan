  ...
  -->
    <div class="app-bar darcula">
      <ul class="app-bar-menu">
        ...
        <li style="<?=$logged_in_style; ?>"><form action="./php/logout.php"><button class="button link fg-white" type="submit"><span class="mif-switch"></span> <?=NAV_BUTTON_LOGOUT; ?></button></form></li>
      ...
      <ul class="app-bar-menu place-right">
        ...
        <span class="app-bar-divider"></span>
        <li><a href="https://github.com/hecki97/stundenplan"><span class="mif-info"></span><?=file_get_contents('version.txt'); ?></a></li>
        <span class="app-bar-divider"></span>
